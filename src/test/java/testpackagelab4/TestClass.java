...
public class TestClass {
    ...
    public void task3AisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in doc(\"DB/books.xml\")/all_books/book return $x/title"));
    }
    ...
    public void task3BisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in distinct-values(doc(\"DB/books.xml\")/all_books/book/author) order by $x return $x"));
    }

    @Test
    public void task3CisCorrect() throws  XQException {
        String expected = "[Action, Comedy, Drama, Poem, Sci-FI]";
        assertEquals(expected,inst.execute("for $x in distinct-values(doc(\"DB/books.xml\")/all_books/book/genre) order by $x return $x"));
    }
    ...
    public void task3DisCorrect() throws  XQException {
        ...
        assertEquals(expected, inst.execute("for $x in distinct-values(doc(\"DB/books.xml\")/all_books/book/city) order by $x return $x"));
    }
    ...
    public void task3EisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in doc(\"DB/books.xml\")/all_books/book where $x/author = \"Trevor T. Pate\" return $x/title"));
    }
    ...
    public void task3FisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in doc(\"DB/books.xml\")/all_books/book where $x/publisher = \"Pellentesque Habitant PC\" return $x/title"));
    }
    ...
    public void task3GisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in doc(\"DB/books.xml\")/all_books/book where $x/genre = \"Sci-FI\" return $x/title"));
    }
    ...
    public void task3HisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in doc(\"DB/books.xml\")/all_books/book where $x/year > 1920 and $x/year < 1970 order by $x/year return $x/title"));
    }
    ...
    public void task3IisCorrect() throws  XQException {
        ...
        assertEquals(expected,inst.execute("for $x in doc(\"DB/books.xml\")/all_books/book where $x/price > 100 and $x/price < 170 order by $x/price return $x/title"));
    }

    @Test
    public void task3JisCorrect() throws  XQException {
        String expected = "[940]";
        assertEquals(expected,inst.execute("let $items := 0 return sum(for $x in doc(\"DB/books.xml\")/all_books/book where $x/author=\"Trevor T. Pate\" return $x/price)"));
    }
